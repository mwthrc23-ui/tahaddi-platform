...
نظام تحدّي واجهة عربية RTL موجهة للمسابقات الحية. يجمع بين خلفية مسرحية هادئة، الأزرق الملكي للإجراء، والذهبي للإنجاز والصدارة. جميع المكوّنات دلالية، قابلة لإعادة الاستخدام، وتعمل في الوضعين الداكن والفاتح.

## الخط

الخط الأساسي **IBM Plex Sans Arabic** ويُحمّل عبر `next/font` بأوزان 400 و500 و600 و700 مع `display: swap`. المتغير `--font-arabic` يربط الخط بـ`--font-sans`، مع بديل نظامي آمن. اختيار الخط يوازن قراءة النصوص الطويلة والأرقام والعناوين الكبيرة.

## الألوان

توجد الرموز في `src/app/globals.css`. لا تستخدم قيمة لون مباشرة داخل مكوّن. أهم المجموعات:
